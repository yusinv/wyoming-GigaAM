            ...
            AsrProgram(
                ...
                models=[
                    ...
                    AsrModel(
                        ...
                        installed=args.model == "v2_ctc",
                        languages=["ru"],
                        version="1",
                    ),
                    AsrModel(
                        name="gigaAM-v3-CTC",
                        description="GigaAM-v3-CTC was trained with a HuBERT-like approach and was fine-tuned with Connectionist Temporal Classification",
                        attribution=Attribution(
                            name="SberDevices",
                            url="https://github.com/salute-developers/GigaAM",
                        ),
                        installed=args.model in ("v3_ctc", "ctc"),
                        languages=["ru"],
                        version="1",
                    ),
                    AsrModel(
                        name="gigaAM-v3-E2E-CTC",
                        description="GigaAM-v3-CTC was trained with a HuBERT-like approach and was fine-tuned with Connectionist Temporal Classification. Where v3_e2e_ctc and v3_e2e_rnnt support punctuation and text normalization",
                        attribution=Attribution(
                            name="SberDevices",
                            url="https://github.com/salute-developers/GigaAM",
                        ),
                        installed=args.model == "v3_e2e_ctc",
                        languages=["ru"],
                        version="1",
                    ),
                    AsrModel(
                    ...
                    AsrModel(
                        name="GigaAM-v2-RNNT",
                        description="GigaAM-v2-RNNT was trained with a HuBERT-like approach and was fine-tuned with RNN Transducer loss",
                        attribution=Attribution(
                            name="SberDevices",
                            url="https://github.com/salute-developers/GigaAM",
                        ),
                        installed=args.model == "v2_rnnt",
                        languages=["ru"],
                        version="1",
                    ),
                    AsrModel(
                        name="GigaAM-v3-RNNT",
                        description="GigaAM-v3-RNNT was trained with a HuBERT-like approach and was fine-tuned with RNN Transducer loss",
                        attribution=Attribution(
                            name="SberDevices",
                            url="https://github.com/salute-developers/GigaAM",
                        ),
                        installed=args.model in ("v3_rnnt", "rnnt"),
                        languages=["ru"],
                        version="1",
                    ),
                    AsrModel(
                        name="GigaAM-v3-E2E-RNNT",
                        description="GigaAM-v3-E2E-RNNT was trained with a HuBERT-like approach and was fine-tuned with RNN Transducer loss. Where v3_e2e_ctc and v3_e2e_rnnt support punctuation and text normalization",
                        attribution=Attribution(
                            name="SberDevices",
                            url="https://github.com/salute-developers/GigaAM",
                        ),
                        installed=args.model == "v3_e2e_rnnt",
                        languages=["ru"],
                        version="1",
                    ),
                ],
